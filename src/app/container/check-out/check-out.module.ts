...
import { shippingReducer } from '../../store-management/reducers/shipping.reducer';
import { ordersumReducer } from '../../store-management/reducers/ordersum.reducer';
...
@NgModule({
  imports: [
    ...
    StoreModule.forFeature('check', Reducers)
  ],
  declarations: [
