...
export class StoreService {
    ...
    private advertisements: AngularFirestoreCollection<any>;
...
;
    constructor(private afs: AngularFirestore, private _http: HttpClient){
        ...
        this.advertisements = afs.collection<any>('adverts');
    }
    ...
    getAdverts(){
        // return a observable
        return this.advertisements.snapshotChanges();
    }
    removeAdverts(id){
        // return a promise
        return this.advertisements.doc(id).delete();
    }
