...
import { AdvertsComponent } from './advertisements/advert-list.component';
import { AdvertAddComponent } from './advertisements/advert-add.component';
...
const routes = [
    {
        ...
        children: [
            ...
            {path: 'advertisements', component: AdvertsComponent},
            {path: 'advertisements/add', component: AdvertAddComponent}
